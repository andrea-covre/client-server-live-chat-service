...
- README.txt
    documentation with description and instruction (this file)
...
> Passsword: cs3251secret (hardcoded)
> Max lenght of message inputtable by
  the client: 1024 charchaters
> Edidted with: CLion 2020.2.4
